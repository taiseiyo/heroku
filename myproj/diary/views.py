...
class DiaryView(TemplateView):
    ...
    def post(self, request):
        if(request.POST["name"] == "taiseiyo" and request.POST["password"] == "welcome"):
            template = loader.get_template('diary/taisei/diary.html')
        ...
        elif(request.POST["name"] == "marubatu" and request.POST["password"] == "welcome"):
            template = loader.get_template('marubatu/marubatu.html')
            return HttpResponse(template.render(None, request))
